...
def on_message(data):
    ...
    if protopie_message_id in subs_msgids_list:
        ...
        if mqtt_topic is not None and mqtt_client is not None:
            if mqtt_client.is_connected():
                ...
                print('But topic:', mqtt_topic, 'payload:', mqtt_msg)
                print('')
        else:
            print('')
            print('ALERT: One of the required value for mqtt publishing is None')
            print('Topic: ', mqtt_topic, ', payload: ', mqtt_msg)
